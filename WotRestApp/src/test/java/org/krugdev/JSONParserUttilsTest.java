...
public class JSONParserUttilsTest {
	...
	public void testIfGetListReturnsArrayOfGenericType() {
		...
		PlayerBasic[] players = JSONParserUtils.getElement(jsonArray, new PlayerBasic[1]);
	...
	public void testIfGetObjectReturnsObjectOfGenericType() {
		...
		PlayerJSONBean playerJsonBean = JSONParserUtils.getElement(jsonObject, new PlayerJSONBean());
